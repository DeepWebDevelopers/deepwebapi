  ...
  async run(message, args, client) {
    ...
    if (!args[0])
      return message.reply(
        "How can you sell nowthing? To check what you can sell run my inventory command."
      );
    ...
    try {
      ...
      if (data.inventory.length <= 0) {
        return message.reply("You dont have anything to sell...");
      }
