...
module.exports = class Command extends commando.Command {
	...
	async run(message, args, client) {
        ...
        const target2 = message.mentions.users.first()
         ...
         if(target2 === message.client.user) return message.reply("I dont want your kisses.")
          if (target2 === message.author) return message.reply("Your a freak for trying that kid!")
